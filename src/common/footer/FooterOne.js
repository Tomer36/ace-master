                            ...
                            <div className="row">
                                {/* <div className="col-sm-6">
                                    <div className="footer-widget">
                                        <h6 className="widget-title">מידע</h6>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="footer-copyright">
                                <span className="copyright-text">© {new Date().getFullYear()} <a href="https://acemaster.online/">ACE-MASTER</a> All rights reserved by</span>
                            </div>
                        </div>
                        <div className="col-md-6">
